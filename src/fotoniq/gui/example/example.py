...
# ----------------------------------
# Created on the Mon Mar 23 2026 by Victor
#
...
Example of a fotonik plot application. This application use 3 classes : 
    * The FotoniQPlotBase which is QtWindows whose central widget contains three
...
Useful method of the FotoniQPlotBase :     
