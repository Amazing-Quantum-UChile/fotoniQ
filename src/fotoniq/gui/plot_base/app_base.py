...
# ----------------------------------
# Created on the Wed Mar 18 2026 by Victor
#
...
from fotoniq.gui.plot_base.parameter_widget_base import ParameterBaseWidget
...
class FotoniQPlotBase(QMainWindow):
    ...
    def _no_callback_message(self):
        ...
        msg += "For example, you could use 'button.clicked.connect(my_callback). In your callback function, backreacts using methods of your model or updating a figure app using the update_plot(ith fig) defined in FotoniQPlotBase.\n"
